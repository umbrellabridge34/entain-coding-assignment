...
var (
	...
	racingApiEndpoint = flag.String("racing-api-endpoint", "localhost:9000", "racing API endpoint")
	sportsApiEndpoint = flag.String("sports-api-endpoint", "localhost:3000", "sports API endpoint")
)
